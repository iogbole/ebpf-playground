...
CONFIG_FILE="/home/israel.linux/proj-9/tcp_retrans_prom/prom_config/prometheus.yml"
sed -i "s/localhost:2112/${IP_ADDRESS}:2112/g" "$CONFIG_FILE"

echo "Updated prometheus.yml with IP address: $IP_ADDRESS"


nerdctl run --rm -p 9090:9090 -v /home/israel.linux/proj-9/tcp_retrans_prom/prom_config:/etc/prometheus prom/prometheus